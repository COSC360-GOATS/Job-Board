...
function JobCard({ job = defaultJob }) {
    ...
    return (
        <div onClick={() => navigate(`/jobs/${job.id}`, { state: { job } })} className="text-white p-8 rounded-lg border border-gray-300 max-w-lg flex flex-col gap-3 cursor-pointer hover:bg-gray-800">
